...
- [x] **Documentation site (/docs)** — Add `/docs` static route with markdown pages: Quick Start, API Reference, Brand Voice Guide. Use `rehype-remark` or plain HTML.
>>>>>>> aae7a8d (Hour 9: Documentation site (/docs) — Quick Start, API Reference, Brand Voice Guide)
